            ...
            <div className="grid grid-cols-2 gap-4 text-left">
              ...
              {gameState.winner.supplyCenters && (
                <div>
                  ...
                  <span className="text-lcars-orange ml-2 font-bold">{gameState.winner.supplyCenters}</span>
                </div>
              )}
              {gameState.winner.combinedSC && (
                <div>
                  <span className="text-gray-400">Combined SCs:</span>
                  <span className="text-lcars-blue ml-2 font-bold">{gameState.winner.combinedSC}</span>
                </div>
              )}
              {gameState.winner.latinum && (
                <div>
                  <span className="text-gray-400">Latinum:</span>
                  <span className="text-ferengi ml-2 font-bold">{gameState.winner.latinum} bars</span>
                </div>
              )}
            </div>
          </div>
                ...
                .map(([f, count]) => (
                  <div key={f} className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <span className={f === selectedFaction ? 'text-white font-bold' : 'text-gray-400'}>
                        {FACTION_NAMES[f]}
                      </span>
                    </div>
